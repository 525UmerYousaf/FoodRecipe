  ...
  return (
    <>
      ...
      <FlatList 
        ...
        keyExtractor={(item) => item.recipeId} // Update the key according to your recipe data
        renderItem={({ item }) => (
          <TouchableOpacity
            style={styles.cardContainer}
            onPress={() => navigation.navigate("RecipeDetail", item)} // Navigate to the article detail 
          >
            <Image 
